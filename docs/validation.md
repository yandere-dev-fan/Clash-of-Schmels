...
- 20 tests pass: production/transport/power, complete harvesting of small tree remnants, building production/delivery notices and empty/full buffer states, finite trees, random rivers on 64 seeds, era gates, migration, offline behavior, isometric picking/flight interpolation, durable local saves and receipt replay after restart, cookie/Origin/receipt forwarding and upstream authorization denial.
